            ...
            <table class="table-responsive table__font" id="target">
                <thead>
                    <tr class="table__font">
                        <th class="table__font" colspan="1">FECHA</th>
                        <th class="table__font" colspan="2">LOTE 1</th>
                        <th class="table__font" colspan="2">LOTE 2</th>
                        <th class="table__font" colspan="2">LOTE 3</th>
                        <th class="table__font" colspan="2">LOTE 4</th>
                        <th class="table__font" colspan="2">LOTE 5</th>
                        <th class="table__font" colspan="2">LOTE 6</th>
                        <th class="table__font" colspan="2">COCIDO</th>
                    </tr>
                </thead>
                <tbody>
