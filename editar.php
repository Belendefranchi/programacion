...
<!-- ---------------------------------------------------------------------------------------------------------- -->
                <div class="row seven-cols">
                    <input type="text" class="col-md-1 form-control">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L1Lun__cantidad?>"   name="L1Lun__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L2Lun__cantidad?>"   name="L2Lun__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L3Lun__cantidad?>"   name="L3Lun__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L4Lun__cantidad?>"   name="L4Lun__cantidad">
...
<!-- ---------------------------------------------------------------------------------------------------------- -->
                <div class="row seven-cols">
                    <input type="text" class="col-md-1 form-control">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L1Mar__cantidad?>"   name="L1Mar__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L2Mar__cantidad?>"   name="L2Mar__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L3Mar__cantidad?>"   name="L3Mar__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L4Mar__cantidad?>"   name="L4Mar__cantidad">
...
<!-- ---------------------------------------------------------------------------------------------------------- -->
                <div class="row seven-cols">
                    <input type="text" class="col-md-1 form-control">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L1Mie__cantidad?>"   name="L1Mie__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L2Mie__cantidad?>"   name="L2Mie__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L3Mie__cantidad?>"   name="L3Mie__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L4Mie__cantidad?>"   name="L4Mie__cantidad">
...
<!-- ---------------------------------------------------------------------------------------------------------- -->
                <div class="row seven-cols">
                    <input type="text" class="col-md-1 form-control">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L1Jue__cantidad?>"   name="L1Jue__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L2Jue__cantidad?>"   name="L2Jue__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L3Jue__cantidad?>"   name="L3Jue__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L4Jue__cantidad?>"   name="L4Jue__cantidad">
...
<!-- ---------------------------------------------------------------------------------------------------------- -->
                <div class="row seven-cols">
                    <input type="text" class="col-md-1 form-control">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L1Vie__cantidad?>"   name="L1Vie__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L2Vie__cantidad?>"   name="L2Vie__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L3Vie__cantidad?>"   name="L3Vie__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L4Vie__cantidad?>"   name="L4Vie__cantidad">
...
<!-- ---------------------------------------------------------------------------------------------------------- -->
                <div class="row seven-cols">
                    <input type="text" class="col-md-1 form-control">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L1Sab__cantidad?>"   name="L1Sab__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L2Sab__cantidad?>"   name="L2Sab__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L3Sab__cantidad?>"   name="L3Sab__cantidad">
                    <input type="text" class="col-md-1 form-control" value="<?php echo $L4Sab__cantidad?>"   name="L4Sab__cantidad">
